...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '13px', 'lineheight' => '20px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#aaa4ab'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '34px', 'lineheight' => '36px', 'face' => 'Ubuntu Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333033'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Ubuntu Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333033'));
			...
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Ubuntu Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333033'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '32px', 'lineheight' => '50px', 'face' => 'Tinos', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333033'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '17px', 'lineheight' => '25px', 'face' => 'Ubuntu Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#9d999d'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '16px', 'lineheight' => '18px', 'face' => 'Ubuntu Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333033'));
// ---------------------------------------------------------
// Map
// ---------------------------------------------------------
			$options[] = array( 
